...
<div class="address">
    <div class="wrapper clearfix"><a href="index.jsp">首页</a><span>/</span><a
            href="flowerDer.jsp">杂志</a><span>/</span><a href="vase_proList.jsp" class="on">15-20年杂志</a></div>
</div><!-------------------current---------------------->
<div class="current">
    <div class="wrapper clearfix"><h3 class="fl">15-20年杂志</h3>
    ...
    <div class="proCon clearfix">
        <div class="proImg fl"><img class="list" src="img/temp/proDet.jpg"/>
            <div class="smallImg clearfix">
                ...
                <img
                    src="img/temp/proDet04.jpg" data-src="img/temp/proDet04_big.jpg"height="800px" width="800px"></div>
        </div>
        <div class="fr">
