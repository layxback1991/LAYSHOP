...
<div class="head ding">
    <div class="wrapper clearfix">
        ...
        <ul class="clearfix" id="bott">
            ...
            <li><a href="selectproductlist">所有商品</a>
                <div class="sList">
                    <div class="wrapper  clearfix"><a href="paint.jsp">
                        <dl>
                            <dt><img src="img/flo4.jpg"width="356px" height="356px"/></dt>
                            <dd>专辑</dd>
                        </dl>
                    </a><a href="paint.jsp">
                        <dl>
                            <dt><img src="img/flo5.jpg"width="356px" height="356px"/></dt>
                            <dd>EP</dd>
                        </dl>
                    </a><a href="paint.jsp">
                        <dl>
                            <dt><img src="img/book.jpg"width="356px" height="356px"/></dt>
                            <dd>而立</dd>
                        </dl>
                    </a><a href="paint.jsp">
                        <dl>
    ...
    <div class="wrapper clearfix">
        <div class="zuo fl">
            <h3><a href="#"><img src="img/tx.png"/></a>
                <p class="clearfix"><span class="fl">[${name.USER_NAME}]</span><span>[<a href="logout">退出登录</a>]</span></p>
            </h3>
            <div><h4>我的交易</h4>
                <ul>
...
<div class="bj">
    ...
    <form action="#" method="get"><p><label>姓名：</label><input type="text" value=""/></p>
        <p><label>生日：</label><input type="text"value=""/></p>
