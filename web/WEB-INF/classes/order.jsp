...
<div class="head ding">
    <div class="wrapper clearfix">
        ...
        <ul class="clearfix" id="bott">
            ...
            <li><a href="flowerDer.jsp">杂志</a>
                <div class="sList2">
                    <div class="clearfix"><a href="proList.jsp">12-14年杂志</a><a href="vase_proList.jsp">15-20年杂志</a></div>
                </div>
            </li>
            <li><a href="decoration.jsp">挂历</a>
                <div class="sList2">
                    <div class="clearfix"><a href="zbproList.jsp">羊汤</a><a href="bzproList.jsp">普通</a></div>
                </div>
            </li>
            <li><a href="paint.jsp">PB</a></li>
            <li><a href="perfume.jsp">海报</a></li>
            <li><a href="idea.jsp">手幅集</a></li>
        </ul>
    </div>
</div>
        ...
        <div class="orderR fr">
            <div class="msg"><h3>订单内容<a href="showcart" class="fr">返回购物车</a></h3><!--------ul---------------->
              ...
              <c:forEach var="rs" items="${requestScope.shoplist }">
                ...
                <ul class="clearfix">
                    <li class="fl"><img width="100" height="100" src="img/${rs.cart_p_filename}"></li>
                    <li class="fl"><p>${rs.cart_p_name }</p
                        <p>内容分类：${rs.cart_p_id}</p>
                        <p>数量：${rs.cart_quantity}</p></li>
                    <li class="fr">￥${rs.cart_p_price * rs.cart_quantity}.00</li>
                </ul>
                <a href="cartshopnumadd?count=${rs.cart_quantity}&num=${rs.cart_p_stock - rs.cart_quantity}&esid=${rs.cart_id}&id=${rs.cart_p_id}&uid=${rs.cart_u_id}&money=${rs.cart_p_price * rs.cart_quantity}" class="pay">去支付</a></div>
                </c:forEach>
...
<%--             <a href="cartshopnumadd?count=${rs.cart_quantity}&num=${rs.cart_p_stock - cart_quantity}&esid=${rs.cart_id}" class="pay">去支付</a></div>--%>
    </div>
</div><!--编辑弹框--><!--遮罩-->
<div class="mask"></div>
