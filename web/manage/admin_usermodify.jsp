    ...
    <div class="main-wrap"style="margin-top: -700px">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font">
            	</i><a href="LayShop/manage/admin_index.jsp">首页</a>
            	<span class="crumb-step">&gt;</span>
            	<a class="crumb-name" href="${pageContext.request.contextPath}/admin_douserselect">用户管理</a>
            	<span class="crumb-step">&gt;</span><span>修改用户</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="${pageContext.request.contextPath}/admin_douserupdate" method="post" id="myform" name="myform">
