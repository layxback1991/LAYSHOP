...
public class Cart {
	...
	public Cart(int cart_id, String cart_p_filename, String cart_p_name, int cart_p_price, int cart_quantity, int cart_p_stock, int cart_p_id, String cart_u_id, String order_time, int cart_valid) {
