...
public class USERDao {
    ...
    public static int update(User u) {
        String sql = "update User set USER_NAME=?, USER_PASSWORD=?,USER_SEX=?,USER_BIRTHDAY=DATE_FORMAT(?, '%y-%m-%d'),USER_IDENITY_CODE=?,USER_EMAIL=?,USER_MOBILE=?,USER_ADDRESS=?,USER_STATUS=?,USER_IP=? where USER_ID = ?";
